...
<div>
    ...
    <ul class="nav nav-pills mb-3">
        ...
        <li class="nav-item"><button class="nav-link @if($tab==='requests') active @endif" wire:click="setTab('requests')">Service Request (Ponpin)</button></li>
    </ul>

    @if($tab==='orders')
        <div class="card"><div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
                <thead><tr><th>#</th><th>Buyer</th><th>Item</th><th>Total</th><th>Status</th><th>Tanggal</th><th></th></tr></thead>
                <tbody>
                    @forelse($orders as $o)
                        <tr>
                    ...
                    @empty
                        <tr><td colspan="7" class="text-center text-secondary small py-3">Belum ada order.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div></div>
    @else
        <div class="card"><div class="table-responsive">
            <table class="table table-sm align-middle mb-0">
                <thead><tr><th>#</th><th>Buyer</th><th>Layanan</th><th>Estimasi</th><th>Jadwal</th><th>Status</th><th></th></tr></thead>
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="7" class="text-center text-secondary small py-3">Belum ada service request.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div></div>
